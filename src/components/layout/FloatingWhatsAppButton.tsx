...
export default function FloatingWhatsAppButton({ phoneNumber, message = "Olá! Vim através do site e gostaria de mais informações." }: FloatingWhatsAppButtonProps) {
  ...
  return (
    <Link
      ...
      className="fixed bottom-6 right-6 h-16 w-16 rounded-full bg-[#25D366] hover:bg-[#20BD5C] text-white shadow-lg z-50 flex items-center justify-center transition-colors duration-200"
    >
