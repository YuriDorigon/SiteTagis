...
export const staticPatientJourneySteps: PatientJourneyStep[] = [
  ...
  { id: 'consulta', title: 'Consulta com o Médico', description: 'Nossos especialistas estão prontos para te atender com dedicação e cuidado.', iconName: 'User', buttonText: 'Nosso Corpo Clínico', buttonLink: '/doutores', buttonVariant: 'outline' },
